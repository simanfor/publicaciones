...
- Bravo, F., Álvarez-González, J.G., del Río, M., Barrio-Anta, M., Bonet, J.A., Bravo-Oviedo, A., Calama, R., Castedo-Dorado, F., Crecente-Campo, F., Condés, S., Diéguez-Aranda, U., González-Martínez, S.C., Lizarralde, I., Nanos, N., Madrigal, A., Martínez-Millán, J., Montero, G., Ordóñez, C., Palahí, M., Piqué, M., Rodríguez, F., Rodríguez-Soallerio, R., Rojo, A., Ruiz-Peinado, R., Sánchez-González, M., Trasobares, A., Vázquez-Piqué, J., 2012. Growth and yield models in Spain: historical overview, contemporary examples and perspectives. Instituto Universitario de Investigación en Gestión Forestal sostenible (Universidad de Valladolid-INIA) y Unidad de Gestión Forestal sostenible (Universidad de Santiago de Compostela).
- Bravo, F., Conejo, R.G., Ordóñez, A.C., Ruiz, J.L.S., 2017. TreeCollect. Aplicación móvil para la toma de datos forestales integrables en SIMANFOR, in: Actas Del 7º Congreso Forestal Español. Plasencia (Spain).
- Bravo, F., Ordóñez, A.C., 2017. SIMANFOR: Avances y nuevas funcionalidades, in: Actas Del 7º Congreso Forestal Español. Plasencia (Spain).
...
- Bravo, F., Rodríguez, F., Ordóñez, A.C., Cartagena, M.B., Lizarralde, I., Río, M.D., Calama, R., Vázquez, J., 2009. SIMANFOR: Herramienta libre para la simulación de sistemas selvícolas, in: Actas Del 5º Congreso Forestal Español. Ávila (Spain).
- Bravo, F., Rodríguez, F., Ordóñez, C., Broto, M., Lizarralde, I., Ruano, I., Río, M.D., Calama, R., 2010. Simanfor: aplicación web para la simulación de alternativas selvıcolas. Divulgación 1er. Trimestre, (100).
- Bravo, F., Vázquez-Veloso, A., 2024. Mixed forest model parameterization and integration into simulation platforms as a tool for decision-making processes. Presented at the Scientific symposium: Promoting diversity in plant-based ecosystems as a tool for Ecosystem Services provision, Palencia, Spain. http://dx.doi.org/10.13140/RG.2.2.27865.94564
- Giménez-García, J.M., Vega-Gorgojo, G., Ordóñez, C., Crespo-Lera, N., Bravo, F., 2024. Improving availability and utilization of forest inventory and land use map data using Linked Open Data. Front. For. Glob. Change 7. https://doi.org/10.3389/ffgc.2024.1329812
- Gómez-Carrión, R., 2024. SIMANFOR V2: Desarrollo de una versión mejorada del portal de simulación de gestión forestal SIMANFOR. Universidad de Valladolid.
- González Manzano, J., 2025. Optimización del potencial productivo de biomasa para fines energéticos en la Sierra de Codés mediante modelización selvícola con SIMANFOR (Bachelor`s thesis). Universidad de Valladolid.
- Martín Ariza, A., Bravo, F., Ordóñez, A.C., 2017. Evaluación de alternativas selvícolas para el almacenamiento de carbono en los ecosistemas forestales de Pinus nigra Arnold, in: Actas Del 7º Congreso Forestal Español, Plasencia.
...
- Peral, B.D.L.P., Rueda, J.A.O.D., Ordóñez, A.C., Bravo, F., Olaizola, J., Aza, C.H.D., 2017. Simulación de la productividad de setas bajo distintos escenarios selvícolas en la plataforma SIMANFOR, in: Actas Del 7º Congreso Forestal Español. Plasencia (Spain).
- Porto-Rodríguez, J.C., Vázquez-Veloso, A., Sánchez-Pellicer, T., Blázquez-Casado, A., Bravo, F., Ruano, I., 2025. Impacto de la gestión forestal en la productividad de bosques mixtos de Quercus pyrenaica en Castilla y León, in: Actas Del 9º Congreso Forestal Español. Gijón (Spain).
- Rodríguez de Prado, D., Bravo, F., Ordoñez, C., 2018. Smartelo, una herramienta informática para el cálculo, gestión y presentación de datos en parcelas forestales, in: Actas Del 7º Congreso Forestal Español. Plasencia (Spain).
- SIMANFOR, 2025. Repositorio oficial de SIMANFOR en GitHub [WWW Document]. URL https://github.com/simanfor
- Vázquez-Veloso, A., 2021. Evaluación y validación de los modelos de crecimiento forestal IBERO-PT e IBERO-PS (Master’s Thesis). Universidad de Valladolid.
- Vázquez-Veloso, Aitor, Alonso, Á.C.O., Oviedo, F.B., 2022. Simulación de la productividad de recursos no maderables (hongos y piñón) bajo diferentes escenarios selvícolas utilizando SIMANFOR, in: Actas Del 8º Congreso Forestal Español. Lleida (Spain).
- Vázquez-Veloso, A., Michalakopoulos, S., Ordóñez, C., Bravo, F., 2023. SMARTELO app: an Android app to plan your harvests, in: XVIIth Young Researchers Meeting on Conservation and Sustainable Use of Forest Systems. University of Valladolid, Palencia, Spain. http://dx.doi.org/10.13140/RG.2.2.27928.06408
- Vázquez-Veloso, A, Ordóñez, C., Bravo, F., 2025a. Silviculture alternatives evaluation for managing complex Quercus pyrenaica Willd. stands. Forest Systems.
- Vázquez-Veloso, A, Ordóñez, C., Bravo, F., 2025b. Evaluación de alternativas selvícolas para la conversión de rebollares a monte alto y su gestión como masas irregulares, in: Actas Del 9º Congreso Forestal Español. Gijón (Spain).
- Vázquez-Veloso, A., Pando, V., Ordóñez, C., Bravo, F., 2022. Evaluación y validación de los modelos de crecimiento forestal IBERO-PT e IBERO-PS para su implementación en SIMANFOR, in: 8º Congreso Forestal Español (Póster). Lleida, España. Lleida, España.
- Vázquez-Veloso, A., Ruano, I., Bravo, F., 2024. Trade-offs and management strategies for ecosystem services in mixed Scots pine and Maritime pine forests. Eur J Forest Res. https://doi.org/10.1007/s10342-024-01752-3
- Vázquez-Veloso, Aitor, Ruano, I., Ordóñez, C., Michalakopoulos, S., Bravo, F., 2025a. Modeling and simulation: supporting complex forest management, in: XIXh Young Researchers Meeting on Conservation and Sustainable Use of Forest Systems. Palencia (Spain). http://dx.doi.org/10.13140/RG.2.2.13936.78081
- Vázquez-Veloso, Aitor, Yang, S.I., Bullock, B.P., Bravo, F., 2025b. Nuevas ecuaciones generalizadas de altura-diámetro para las especies forestales españolas, in: Actas Del 9º Congreso Forestal Español. Gijón (Spain).
- Vázquez-Veloso, Aitor, Yang, S.-I., Bullock, B.P., Bravo, F., 2025c. One model to rule them all: A nationwide height–diameter model for 91 Spanish forest species. Forest Ecology and Management 595, 122981. https://doi.org/10.1016/j.foreco.2025.122981
